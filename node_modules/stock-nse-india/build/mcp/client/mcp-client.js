...
exports.createMCPClient = exports.getMcpClient = exports.MCPClient = void 0;
...
class MCPClient {
    ...
    getMemoryManager() {
        if (!this.memoryManager) {
            this.memoryManager = new memory_manager_js_1.MemoryManager(this.config.memoryConfig);
        }
