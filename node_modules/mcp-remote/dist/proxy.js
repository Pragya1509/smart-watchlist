...
// src/proxy.ts
async function runProxy(serverUrl, callbackPort, specifiedPort, headers, transportStrategy = "http-first", host, staticOAuthClientMetadata, staticOAuthClientInfo, authorizeResource, skipResourceParameter, ignoredTools, authTimeoutMs, serverUrlHash) {
...
parseCommandLineArgs(process.argv.slice(2), "Usage: mcp-remote <https://server-url> [callback-port] [--debug]").then(
  ({
    serverUrl,
    callbackPort,
    specifiedPort,
