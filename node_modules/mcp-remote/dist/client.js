...
async function runClient(serverUrl, callbackPort, specifiedPort, headers, transportStrategy = "http-first", host, staticOAuthClientMetadata, staticOAuthClientInfo, authorizeResource, skipResourceParameter, authTimeoutMs, serverUrlHash) {
...
parseCommandLineArgs(process.argv.slice(2), "Usage: mcp-remote-client <https://server-url> [callback-port] [--debug]").then(
  ({
    serverUrl,
    callbackPort,
    specifiedPort,
